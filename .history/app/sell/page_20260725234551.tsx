...
export default function SellPage() {
  ...
  if (ld) return <div style={{background:'#1a1a1a',color:'#fff',height:'100vh',display:'flex',alignItems:'center',justifyContent:'center'}}>Accessing Direct Sales & Commodity Terminal...</div>;
