            ...
            <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
                ...
                <div style={{ 
                    ...
                    <p style={{ fontSize: '14px', color: '#9ca3af', lineHeight: '1.6' }}>
                        Track seasonal farming challenges, productivity leaderboards, and community awards across <span style={{ color: '#34d399', fontWeight: 'bold' }}>Judith Plains Montana 4X</span>.
                    </p>
                </div>
            </div>
        </div>
