...
import { ArrowLeft, Building2, ShieldCheck, MapPin, Users, Briefcase } from 'lucide-react';
...
export default function CompaniesPage() {
  const [companies] = useState([
    ...
    {
      id: 3,
      name: 'Daisy Hill Agro-Chemicals',
      sector: 'Supplies & Nutrients',
      location: 'Sector 1 - Research Facility',
      employees: 6,
      status: 'Active Partner',
      description: 'Bulk provider of organic fertilizers, seed optimization formulas, and soil health diagnostics.'
    }
  ]);
      ...
      <main style={{ maxWidth: '1400px', margin: '0 auto', padding: '40px 32px' }}>
        <div style={{ marginBottom: '32px', borderBottom: '1px solid #1f2937', paddingBottom: '24px' }}>
          ...
          <p style={{ fontSize: '13px', color: '#9ca3af', margin: 0, textTransform: 'uppercase', letterSpacing: '0.03em' }}>
            Registered commercial entities, co-ops, and operational partners operating within the Daisy Hill network.
          </p>
        </div>
