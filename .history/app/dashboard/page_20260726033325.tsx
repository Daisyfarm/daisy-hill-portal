...
import { ShieldCheck, Clock, User, Gamepad2, MessageSquare, LogOut, ArrowRight } from 'lucide-react';

export default function StatusDashboardPage() {
  // Mock data representing a logged-in user retrieved from your database/session
  const [userData] = useState({
    username: 'FarmerJoe',
    email: 'joe@example.com',
    discord: 'FarmerJoe#1234',
    steamId: 'steam:11000010f234abc',
    status: 'PENDING_REVIEW', // Options: PENDING_REVIEW, APPROVED, REJECTED
      ...
      <header style={{ backgroundColor: 'rgba(11, 14, 20, 0.85)', backdropFilter: 'blur(8px)', borderBottom: '1px solid rgba(39, 39, 42, 0.6)', padding: '16px 24px', fontSize: '12px', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '24px', flexWrap: 'wrap' }}>
            ...
            <span style={{ color: '#34d399' }}>Member Status Dashboard</span>
          </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          <div style={{ backgroundColor: 'rgba(15, 17, 23, 0.85)', backdropFilter: 'blur(10px)', border: '1px solid rgba(39, 39, 42, 0.6)', padding: '24px', borderRadius: '12px', boxShadow: '0 8px 32px rgba(0, 0, 0, 0.4)' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '14px', fontSize: '13px' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'between', gap: '10px', background: 'rgba(5, 7, 10, 0.6)', padding: '10px', borderRadius: '6px', border: '1px solid #3f3f46' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'between', gap: '10px', background: 'rgba(5, 7, 10, 0.6)', padding: '10px', borderRadius: '6px', border: '1px solid #34d399' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
