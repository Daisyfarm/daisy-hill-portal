...
import { Shield, Tractor, Users, HelpCircle, BookOpen } from 'lucide-react';
      ...
      <nav style={{ backgroundColor: 'rgba(11, 14, 20, 0.95)', borderBottom: '1px solid rgba(39, 39, 42, 0.6)', padding: '12px 24px', position: 'sticky', top: 0, zIndex: 100, backdropFilter: 'blur(8px)' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px', fontSize: '12px', fontWeight: 'bold', textTransform: 'uppercase' }}>
            ...
            <Link href="/rules" style={{ color: '#e4e4e7', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '6px', padding: '6px 10px', borderRadius: '4px', backgroundColor: 'rgba(255, 255, 255, 0.05)' }}>
              <BookOpen size={14} color="#34d399" /> Rules
            </Link>
