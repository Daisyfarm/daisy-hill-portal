...
export default function RegistrationPage() {
  ...
  return (
    <div style={{ 
      minHeight: '100vh', 
      backgroundImage: 'linear-gradient(rgba(5, 7, 10, 0.85), rgba(5, 7, 10, 0.90)), url("/JD2.jpg")', 
      ...
      <main style={{ maxWidth: '1280px', margin: '0 auto', padding: '40px 24px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '32px', alignItems: 'start' }}>
        ...
        {/* Welcome Section */}
        <div style={{ backgroundColor: 'rgba(15, 17, 23, 0.82)', backdropFilter: 'blur(10px)', border: '1px solid rgba(39, 39, 42, 0.6)', padding: '32px', borderRadius: '12px', boxShadow: '0 8px 32px rgba(0, 0, 0, 0.4)' }}>
